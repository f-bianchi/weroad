  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <form @submit.prevent="handleSubmit">
        ...
        <div class="border-b border-gray-900/10 pb-8">
          ...
          <div class="mt-8">
            ...
            <div class="mt-2">
              <input id="new-password" name="new-password" type="password" autocomplete="new-password"
                v-model="form.password" :required="!isEditing"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div class="mt-8">
            <Listbox as="div" v-model="form.roles" multiple>
              <ListboxLabel class="block text-sm font-medium leading-6 text-gray-900">Roles *</ListboxLabel>
              <div class="relative mt-2">
                ...
                <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
                  ...
                  <ListboxOptions
                    ...
                    <ListboxOption as="template" v-for="role in ROLES" :key="role" :value="role"
                      :disabled="form.roles.length === 1 && form.roles[0] === role" v-slot="{ active, selected }">
                      <li
                        :class="[active ? 'bg-rose-600 text-white' : 'text-gray-900', 'relative cursor-default select-none py-2 pl-3 pr-9']">
          ...
          <div class="mt-12" v-if="isEditing">
            <ConfirmDialog title="Logout" message="Are you sure you want to remove this user?" @confirm="removeUser"
              v-slot="scope">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        <RouterLink to="/admin/users" type="button" class="text-sm font-semibold leading-6 text-gray-900">
          Cancel
        </RouterLink>
        <button type="submit"
