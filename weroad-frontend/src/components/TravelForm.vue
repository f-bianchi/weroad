  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <form @submit.prevent="handleSubmit">
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-8">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="relative flex gap-x-3 sm:col-span-6">
              <div class="flex h-6 items-center">
                <input id="comments" name="comments" type="checkbox" v-model="form.isPublic"
                  class="h-4 w-4 rounded border-gray-300 text-rose-600 focus:ring-rose-600" />
              </div>
              <div class="text-sm leading-6">
                <label for="comments" class="font-medium text-gray-900 cursor-pointer">Public</label>
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-2">
                <input type="text" name="slug" id="slug" required v-model="form.slug"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <textarea id="about" name="about" rows="10" equired v-model="form.description"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6" />
              </div>
            </div>

            <div class="sm:col-span-1">
              <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Number of days *</label>
              <div class="mt-2">
                <input type="number" name="days" id="days" step="1" min="1" required v-model="form.numberOfDays"
                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6" />
              </div>
            </div>

            <div class="sm:col-span-1">
              <label for="slug" class="block text-sm font-medium leading-6 text-gray-900">Number of nights *</label>
              <div class="mt-2">
                <input type="number" name="nights" id="nights" step="1" min="0" required v-model="form.numberOfNights"
                  disabled
          ...
          <div class="mt-12" v-if="isEditing">
            <ConfirmDialog title="Logout" message="Are you sure you want to remove this travel?" @confirm="removeTravel"
              v-slot="scope">
              <button @click="scope.toggle" type="button"
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        <RouterLink to="/admin/travels" type="button" class="text-sm font-semibold leading-6 text-gray-900">
          Cancel
        </RouterLink>
        <button type="submit"
