            ...
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <CheckCircleIcon v-if="notification.type === 'success'" class="h-6 w-6 text-green-400"
                  aria-hidden="true" />
                <ExclamationTriangleIcon v-if="notification.type === 'error'" class="h-6 w-6 text-red-600"
                  aria-hidden="true" />
                <InformationCircleIcon v-if="notification.type === 'info'" class="h-6 w-6 text-blue-600"
                  aria-hidden="true" />
              </div>
              ...
              <div class="ml-4 flex flex-shrink-0">
                <button type="button" @click="closeNotification(index)"
