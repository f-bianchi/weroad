  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      ...
      <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <RouterLink to="/admin/travels/create"
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="travel in travels" :key="travel.id">
                  ...
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    ...
                    <span v-else
                      class="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset">Draft</span>
                  </td>
                  <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    {{ travel.numberOfDays }}
                  </td>
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                    <RouterLink :to="`/admin/travels/${travel.id}`" class="text-rose-600 hover:text-rose-900">
                      Edit
                    </RouterLink>
                  </td>
                </tr>
